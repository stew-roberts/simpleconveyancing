...
<body class="" style="overflow-y: visible;">
    ...
    <section id="localquotes" class="container">
        <h2><?php echo $locality ?> Conveyancing</h2>
        <p>You can compare low cost, cheap residential conveyancing quotes in <?php echo $locality ?> and conveyancing solicitors in <?php echo $locality ?>. Using our online conveyancing quotes comparison service, you can find low cost, cheap, quality online conveyancing quotes from SRA regulated solicitors and CLC regulated licensed conveyancers in the <?php echo $locality ?> area.</p>
        <p>Compare Conveyancing Quotes Online for Solicitors in <?php echo $locality ?></p>
        <p>Using the conveyancing comparison tool below, you can compare and instruct different solicitors and conveyancers both nationally in the UK and in <?php echo $locality ?>.</p>
